 ...
 * --------------------
 * ver 1.2 : 23 Nov 2015
 * - added isLoggerEnabled flag and TryGetElementValue method.
 * ver 1.1 : 24 Oct 2015
...
namespace Project4Starter
{
  static public class Utilities
  {
    ...
    //added for project#4 - logging switch
    public static bool isLoggerEnabled { get; set; } = false;
    ...
    public static void showMessage(Message msg)
    {
      ...
      Console.Write("\n  msg.content: {0}", msg.content);
        ...
        //added for project#4 - utility method to get value of an element from xml.
